...
export function createConference(conference) {
  return {
    ...
    payload: axios.post(`${REACT_APP_API_STG_URL}/api/conference/create`, conference, {
...
export function getAllConferences() {
  return {
    ...
    payload: axios.get(`${REACT_APP_API_STG_URL}/api/conference/`)
  };
}
...
export function getConference(conference) {
  return {
    type: GET_CONFERENCE,
    payload: axios.get(`${REACT_APP_API_STG_URL}/api/conference/${conference.id}`)
  };
}
...
export function updateConference(conference) {
  return {
    ...
    payload: axios.put(`${REACT_APP_API_STG_URL}/api/conference/update`, conference, {
      headers: { 'Authorization': localStorage.getItem('Authorization') }
    })
  };
}
...
export function updateConferenceStatus(conference) {
  return {
    ...
    payload: axios.put(`${REACT_APP_API_STG_URL}/api/conference/updatestatus`, conference, {
      headers: { 'Authorization': localStorage.getItem('Authorization') }
    })
  };
}
...
export function deleteConference(conference) {
  return {
    ...
    payload: axios.delete(`${REACT_APP_API_STG_URL}/api/conference/delete/${conference.id}`, {
      headers: { 'Authorization': localStorage.getItem('Authorization') }
    })
  };
}